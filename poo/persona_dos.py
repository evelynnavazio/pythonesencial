class Persona:
    ...
    def cumplir_anios(self):
        self.edad += 1
        print(f"Feliz cupleaños #{self.edad} {self.nombre}")
...
class Empleado(Persona):
    ...
    def trabajar(self, horas_trabajadas):
        ...
        print(f"Usted a trabajado {horas_trabajadas} horas")
        print(f"Horas totales:{self.horas_totales}")


# atributos son las propiedades de la clase.
# atributos de la instancia se definen dentro de la instruccion
# metodos se definent dentro de la clase
# clase padre y clase hijo
